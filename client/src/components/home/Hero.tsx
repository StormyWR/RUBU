  ...
  export default function Hero() {
    return (
      <div className="pt-0 pb-16 md:py-10">
        {/* Hero Banner */}
        <div
            className="flex flex-col-reverse md:flex-row items-center md:items-stretch justify-center md:justify-between mb-8 md:mb-12 min-h-[300px]">
          <motion.div
              className="w-full md:w-1/2 mt-10 md:mt-0 md:pr-8 md:pl-8 flex flex-col justify-center h-full text-center md:text-left"
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            <Link href="/servers">
              <Button size="lg"
                      className="bg-primary hover:bg-primary text-white font-bold px-6 transition-all transform hover:-translate-y-1 shadow-lg group">
        ...
        >
          ...
          <div className="bg-dark p-8 rounded-xl border border-teal-700 border-opacity-20 flex items-start relative overflow-hidden">
            ...
            <div className="z-10">
              ...
              <p className="text-light-dark text-sm opacity-80">All servers wipe on Thursdays at 1:00pm</p>
            </div>
          </div>
